...
import 'saved_filings_screen.dart'; // Import the Saved Filings Screen
                    ...
                    TextButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => SavedFilingsScreen(allFilings: filings),
                          ),
                        );
                      },
                      child: const Text('View Saved Filings'),
                    ),
                  ],
                ),
              ),
